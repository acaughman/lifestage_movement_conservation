...
### Need to find kfin and rfin, get geographic range

Manually calculated movement keyword based on demers_pelag value from fishbase with table from Bradley et al., 2023 (unpublished)
...
```{r}
write_csv(data, here::here("01_data", "02_processed_data", "pisco_rf_data.csv"))
```
